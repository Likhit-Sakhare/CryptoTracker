...
import com.likhit.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
import com.likhit.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.likhit.cryptotracker.crypto.presentation.utils.toDisplayableNumber
import com.likhit.cryptotracker.ui.theme.greenBackground
        ...
        Column(
            ...
            FlowRow(
                ...
                val absoluteChangeFormatted = (coin.priceUsd.value
                        * (coin.changePercent24Hrs.value / 100)).toDisplayableNumber()
                val isPositive = coin.changePercent24Hrs.value > 0.0
                val positiveNegativeColor = if(isPositive){
                ...
                InfoCard(
                    ...
                    contentColor = positiveNegativeColor
                )
            }
            AnimatedVisibility(
                ...
                val startIndex = (coin.coinPriceHistory.lastIndex
                        - amountOfVisibleDataPoints).coerceAtLeast(0)
                LineChart(
